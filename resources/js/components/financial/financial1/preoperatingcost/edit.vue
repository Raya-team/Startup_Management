                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item text-muted">
                                ویرایش هزینه های قبل بهره برداری
                            </li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                                ...
                                <div class="card-body">
                                    <div id="kt_repeater_1">
                                        <div class="form-group row">
                                            <label class="col-lg-2 col-form-label text-right"><h4>ویرایش هزینه ها:</h4></label>
    ...
    export default {
        ...
        created() {
            ...
            axios.get(`/api/preoperatingcosts/${this.$route.params.id}/edit`)
                .then(response => {
                    ...
                    this.data.preoperatingcosts[0].total_price = response.data.preoperatingcosts.total_price;
                })
        ...
        methods: {
            onSubmit() {
                ...
                axios.put(`/preoperatingcosts/${this.$route.params.id}`, this.data)
                    .then(response => {
