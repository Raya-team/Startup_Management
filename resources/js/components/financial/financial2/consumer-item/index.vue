                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-header border-0 py-5">
                        ...
                        <div class="card-toolbar">
                            <router-link :to="{ name: 'consumeritems-create', params: { year: this.$route.params.id }}">
                        ...
                        <div class="table-responsive">
                            <table class="table table-head-custom table-head-bg table-vertical-center table-borderless" id="myTable">
                                ...
                                <tr v-for="(consumeritem, index) in consumeritemsFilter" :id="'del'+consumeritem.id" class="text-center">
                                    ...
                                    <td>
                                        <span class="text-dark-75">{{ consumeritem.description }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-75">{{ consumeritem.number }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-750">{{ consumeritem.unit_cost }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-750">{{ consumeritem.total_cost }}</span>
                                    </td>
                                    <td>
                                        <router-link :to="{ name: 'consumeritems-edit', params: { id: consumeritem.id }}">
...
<script>
    ...
    export default {
        ...
        methods: {
            getResults(pagi) {
                pagi = pagi || `/api/consumeritems/${this.$route.params.id}`;
                axios.get(pagi)
                    .then(response => {
                        this.consumeritems = response.data.data;
                        this.pagination = {
        ...
        computed: {
            consumeritemsFilter() {
                return this.consumeritems.filter((element) => {
                    if(!this.filterText){
                        return element
                    }else{
