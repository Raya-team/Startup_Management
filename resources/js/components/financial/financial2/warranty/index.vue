                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-header border-0 py-5">
                        ...
                        <div class="card-toolbar">
                            <router-link :to="{ name: 'warranties-create', params: { year: this.$route.params.id }}">
                    ...
                    <div class="card-body pt-0 pb-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-head-custom table-head-bg table-vertical-center table-borderless" id="myTable">
                                ...
                                <tbody>
                                <tr v-for="(warranty, index) in warrantiesFilter" :id="'del_'+warranty.id" class="text-center">
                                    <td>
                                    ...
                                    <td>
                                        <span class="text-dark-750">{{ warranty.total_cost }}</span>
                                    </td>
                                    <td>
                                        <router-link :to="{ name: 'warranties-edit', params: { id: warranty.id }}">
                                            <a class="btn btn-icon btn-light-success btn-sm mr-2">
                                                <i class="flaticon2-edit"></i>
                                            </a>
                                        </router-link>
                                        <button type="button" @click="deleteWarranty(warranty.id, index)"  class="btn btn-icon btn-light-danger btn-sm mr-2">
                                            <i class="flaticon2-trash" :id="'icon_'+warranty.id"></i>
                                        </button>
                                    </td>
                                    <hr>
                                </tr>
...
<script>
    ...
    export default {
        ...
        methods: {
            getResults(pagi) {
                pagi = pagi || `/api/warranties/${this.$route.params.id}`;
                axios.get(pagi)
                    .then(response => {
        ...
        computed: {
            warrantiesFilter() {
                return this.warranties.filter((element) => {
                    if(!this.filterText){
                        return element
                    }else{
