...
<script>
    ...
    export default {
        ...
        created() {
            this.Auth.check();
            axios.get(`/api/insurances/${this.$route.params.id}/edit`)
                .then(response => {
        ...
        methods: {
            onSubmit() {
                ...
                axios.put(`/insurances/${this.$route.params.id}`, this.data)
                    .then(response => {
                        if(response.data[0] == 'success'){
                            ...
                            setTimeout(() => {
                                var someTabTriggerEl = document.querySelector('#insurance-tab');
