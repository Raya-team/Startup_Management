                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-header border-0 py-5">
                        ...
                        <div class="card-toolbar">
                            <router-link :to="{ name: 'repairs-create', params: { year: this.$route.params.id }}">
                    ...
                    <div class="card-body pt-0 pb-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-head-custom table-head-bg table-vertical-center table-borderless" id="myTable">
                                ...
                                <tbody>
                                <tr v-for="(repair, index) in repairsFilter" :id="'del_'+repair.id" class="text-center">
                                    <td>
                                        <span class="text-dark-75">{{ ++index }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-75">{{ repair.description }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-75">{{ repair.percent }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-750">{{ repair.total_cost }}</span>
                                    </td>
                                    <td>
                                        ...
                                        <button type="button" @click="deleteRepair(repair.id, index)"  class="btn btn-icon btn-light-danger btn-sm mr-2">
                                            <i class="flaticon2-trash" :id="'icon_'+repair.id"></i>
                                        </button>
                                    </td>
                                    <hr>
                                </tr>
...
<script>
    ...
    export default {
        ...
        methods: {
            getResults(pagi) {
                pagi = pagi || `/api/repairs/${this.$route.params.id}`;
                axios.get(pagi)
                    .then(response => {
        ...
        computed: {
            repairsFilter() {
                return this.repairs.filter((element) => {
                    if(!this.filterText){
                        return element
                    }else{
