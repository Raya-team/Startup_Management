...
<script>
    ...
    export default {
        ...
        created() {
            axios.get(`/api/aftersaleservices/${this.$route.params.id}/edit`)
                .then(response => {
                    this.year = response.data.year;
                    this.data.after_sale_service[0].description = response.data.description;
                    this.data.after_sale_service[0].number = response.data.number;
                    this.data.after_sale_service[0].unit_cost = response.data.unit_cost;
                    this.data.after_sale_service[0].total_cost = response.data.total_cost;
                })
        ...
        methods: {
            onSubmit() {
                ...
                axios.put(`/aftersaleservices/${this.$route.params.id}`, this.data)
                    .then(response => {
