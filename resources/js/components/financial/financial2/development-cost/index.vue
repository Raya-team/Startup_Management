                        ...
                        <div class="table-responsive">
                            <table class="table table-head-custom table-head-bg table-vertical-center table-borderless" id="myTable95">
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <span class="text-dark-75">{{ data.total_cost }}</span>
                                    </td>
                                    <td>
                                        <router-link :to="{ name: 'developmentcosts-edit', params: { id: data.id }}">
...
<script>
    ...
    export default {
        ...
        created() {
            this.Auth.check();
            axios.get(`/api/developmentcosts/${this.$route.params.id}`)
                .then(response => {
