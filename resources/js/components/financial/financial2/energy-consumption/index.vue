                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-header border-0 py-5">
                        ...
                        <div class="card-toolbar">
                            <router-link :to="{ name: 'energyconsumptions-create', params: { year: this.$route.params.id }}">
                        ...
                        <div class="table-responsive">
                            <table class="table table-head-custom table-head-bg table-vertical-center table-borderless" id="myTable">
                                ...
                                <tr class="bg-gray-100 text-center">
                                    ...
                                    <th>هزینه سالیانه(تومان)</th>
                                    <th>عملیات</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr v-for="(energyconsumption, index) in energyconsumptionsFilter" :id="'del_'+energyconsumption.id" class="text-center">
                                    <td>
                                    ...
                                    <td>
                                        <span class="text-dark-750">{{ energyconsumption.unit_cost }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-750">{{ energyconsumption.annual_cost }}</span>
                                    </td>
                                    <td>
                                        <router-link :to="{ name: 'energyconsumptions-edit', params: { id: energyconsumption.id }}">
                                            <a class="btn btn-icon btn-light-success btn-sm mr-2">
                                                <i class="flaticon2-edit"></i>
                                            </a>
                                        </router-link>
                                        <button type="button" @click="deleteEnergyConsumption(energyconsumption.id, index)"  class="btn btn-icon btn-light-danger btn-sm mr-2">
                                            <i class="flaticon2-trash" :id="'icon_'+energyconsumption.id"></i>
                                        </button>
                                    </td>
                                    <hr>
                                </tr>
...
<script>
    ...
    export default {
        ...
        methods: {
            getResults(pagi) {
                pagi = pagi || `/api/energyconsumptions/${this.$route.params.id}`;
                axios.get(pagi)
                    .then(response => {
                        this.energyconsumptions = response.data.data;
                        this.pagination = {
            ...
            deleteEnergyConsumption(id, index) {
                this.Auth.check();
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        axios.delete(`/energyconsumptions/${id}`)
                            .then(response => {
        ...
        computed: {
            energyconsumptionsFilter() {
                return this.energyconsumptions.filter((element) => {
                    if(!this.filterText){
                        return element
                    }else{
