                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-header border-0 py-5">
                        ...
                        <div class="card-toolbar">
                            <router-link :to="{ name: 'outsourcings-create', params: { year: this.$route.params.id }}">
                    ...
                    <div class="card-body pt-0 pb-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-head-custom table-head-bg table-vertical-center table-borderless" id="myTable">
                                ...
                                <tbody>
                                <tr v-for="(aftersaleservice, index) in outsourcingsFilter" :id="'del_'+aftersaleservice.id" class="text-center">
                                    <td>
                                    ...
                                    <td>
                                        <router-link :to="{ name: 'outsourcings-edit', params: { id: aftersaleservice.id }}">
...
<script>
    ...
    export default {
        ...
        methods: {
            getResults(pagi) {
                pagi = pagi || `/api/outsourcings/${this.$route.params.id}`;
                axios.get(pagi)
                    .then(response => {
                        this.outsourcings = response.data.data;
                        this.pagination = {
        ...
        computed: {
            outsourcingsFilter() {
                return this.outsourcings.filter((element) => {
                    if(!this.filterText){
                        return element
                    }else{
