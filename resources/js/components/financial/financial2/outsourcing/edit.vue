...
<script>
    ...
    export default {
        ...
        created() {
            axios.get(`/api/outsourcings/${this.$route.params.id}/edit`)
                .then(response => {
                    this.year = response.data.year;
                    this.data.outsourcing[0].description = response.data.description;
                    this.data.outsourcing[0].number = response.data.number;
                    this.data.outsourcing[0].unit_cost = response.data.unit_cost;
                    this.data.outsourcing[0].total_cost = response.data.total_cost;
                })
        ...
        methods: {
            onSubmit() {
                ...
                axios.put(`/outsourcings/${this.$route.params.id}`, this.data)
                    .then(response => {
                        if(response.data[0] == 'success'){
                            ...
                            setTimeout(() => {
                                var someTabTriggerEl = document.querySelector('#outsourcing-tab');
