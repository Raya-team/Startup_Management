...
<script>
    ...
    export default {
        ...
        created() {
            axios.get(`/api/rds/${this.$route.params.id}/edit`)
                .then(response => {
                    this.year = response.data.year;
                    this.data.r_d[0].description = response.data.description;
                    this.data.r_d[0].annual_cost = response.data.annual_cost;
                })
        ...
        methods: {
            onSubmit() {
                ...
                axios.put(`/rds/${this.$route.params.id}`, this.data)
                    .then(response => {
                        if(response.data[0] == 'success'){
                            ...
                            setTimeout(() => {
                                var someTabTriggerEl = document.querySelector('#rd-tab');
