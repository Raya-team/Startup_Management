...
<script>
    ...
    export default {
        ...
        created(){
            this.Auth.check();
            axios.get(`/api/description-managerial/${this.$route.params.id}/edit`)
                .then(response => {
                    this.data.managerial = response.data.managerial;
        ...
        methods: {
            onSubmit() {
                ...
                axios.put(`/description-managerial/${this.$route.params.id}`, this.data)
                    .then(response => {
                        Swal.fire({
