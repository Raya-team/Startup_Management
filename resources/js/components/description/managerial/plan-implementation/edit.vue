...
<script>
    ...
    export default {
        ...
        created() {
            axios.get(`/api/description-planimplementations/${this.$route.params.id}/edit`)
                .then(response => {
                    this.data.plan_implementations[0].subject_of_work = response.data.subject_of_work;
                    this.data.plan_implementations[0].duration_of_work = response.data.duration_of_work;
                })
        ...
        methods: {
            onSubmit() {
                ...
                axios.put(`/description-planimplementations/${this.$route.params.id}`, this.data)
                    .then(response => {
