                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a class="text-muted">عرضه کننده</a>
                            </li>
                            <li class="breadcrumb-item text-muted">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form class="form" novalidate="novalidate" id="kt_login_signup_form" @submit.prevent="onSubmit">
                                <div class="card-body">
                                    <div class="form-group row" v-for="(pro, index) in data.suppliers" :key="index">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                data: {
                    suppliers: [{ name: '', geographical_region: '' }],
                },
                errors: new Errors(),
                Auth: new Auth()
            }
        ...
        created() {
            axios.get(`/api/suppliers/${this.$route.params.id}/edit`)
                .then(response => {
                    this.data.suppliers[0].name = response.data.name;
                    this.data.suppliers[0].geographical_region = response.data.geographical_region;
                })
        ...
        methods: {
            onSubmit() {
                ...
                axios.put(`/suppliers/${this.$route.params.id}`, this.data)
                    .then(response => {
