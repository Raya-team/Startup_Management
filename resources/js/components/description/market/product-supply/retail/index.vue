        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 py-5">
                ...
                <div class="card-toolbar">
                    <router-link :to="{ name: 'retails-create'}">
            ...
            <div class="card-body pt-0 pb-3">
                ...
                <div class="table-responsive">
                    <table class="table table-head-custom table-head-bg table-vertical-center table-borderless" id="myTable">
                        ...
                        <tbody>
                        <tr v-for="(data, index) in retailsFilter" :id="'del_'+data.id" class="text-center">
                            <td>
                            ...
                            <td>
                                <router-link :to="{ name: 'retails-edit', params: { id: data.id }}">
                                    <a class="btn btn-icon btn-light-success btn-sm mr-2">
                                        <i class="flaticon2-edit"></i>
                                    </a>
                                </router-link>
                                <button type="button" @click="deleteretails(data.id, index)"  class="btn btn-icon btn-light-danger btn-sm mr-2">
...
<script>
    ...
    export default {
        ...
        methods: {
            getResults(pagi) {
                pagi = pagi || `/api/retails`;
                axios.get(pagi)
                    .then(response => {
                        this.retails = response.data.data;
                        this.pagination = {
        ...
        computed: {
            retailsFilter() {
                return this.retails.filter((element) => {
                    if(!this.filterText){
                        return element
                    }else{
