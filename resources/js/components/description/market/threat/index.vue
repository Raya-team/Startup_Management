                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-header border-0 py-5">
                        ...
                        <div class="card-toolbar">
                            <router-link :to="{ name: 'threats-create'}">
                    ...
                    <div class="card-body pt-0 pb-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-head-custom table-head-bg table-vertical-center table-borderless" id="myTable">
                                ...
                                <tbody>
                                <tr v-for="(data, index) in threatsFilter" :id="'del_'+data.id" class="text-center">
                                    <td>
                                    ...
                                    <td>
                                        <router-link :to="{ name: 'threats-edit', params: { id: data.id }}">
                                            <a class="btn btn-icon btn-light-success btn-sm mr-2">
                                                <i class="flaticon2-edit"></i>
                                            </a>
                                        </router-link>
                                        <button type="button" @click="deletethreats(data.id, index)"  class="btn btn-icon btn-light-danger btn-sm mr-2">
...
<script>
    ...
    export default {
        ...
        methods: {
            getResults(pagi) {
                pagi = pagi || `/api/threats`;
                axios.get(pagi)
                    .then(response => {
                        this.threats = response.data.data;
                        this.pagination = {
        ...
        computed: {
            threatsFilter() {
                return this.threats.filter((element) => {
                    if(!this.filterText){
                        return element
                    }else{
