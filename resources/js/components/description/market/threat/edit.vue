                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form class="form" novalidate="novalidate" id="kt_login_signup_form" @submit.prevent="onSubmit">
                                <div class="card-body">
                                    <h5 class="text-dark font-weight-bold">نقاط تهدید</h5><br>
...
<script>
    ...
    export default {
        ...
        created() {
            axios.get(`/api/threats/${this.$route.params.id}/edit`)
                .then(response => {
                    this.data.threats[0].description = response.data.description;
                    this.data.threats[0].weight = response.data.weight;
                    this.data.threats[0].score = response.data.score;
                })
        ...
        methods: {
            onSubmit() {
                ...
                axios.put(`/threats/${this.$route.params.id}`, this.data)
                    .then(response => {
                        if(response.data[0] == 'success'){
                            ...
                            setTimeout(() => {
                                var someTabTriggerEl = document.querySelector('#threats-tab');
