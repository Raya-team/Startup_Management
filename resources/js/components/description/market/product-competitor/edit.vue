                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a class="text-muted">رقبای محصول</a>
                            </li>
                            <li class="breadcrumb-item text-muted">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                data: {
                    product_competitors: [{ name: '', geographical_region: '', market_share: '', competitive_feature: '', weakness: '' }],
                },
                errors: new Errors(),
                Auth: new Auth()
            }
        ...
        created() {
            axios.get(`/api/product-competitors/${this.$route.params.id}/edit`)
                .then(response => {
                    this.data.product_competitors[0].name = response.data.name;
                    this.data.product_competitors[0].geographical_region = response.data.geographical_region;
                    this.data.product_competitors[0].market_share = response.data.market_share;
                    this.data.product_competitors[0].competitive_feature = response.data.competitive_feature;
                    this.data.product_competitors[0].weakness = response.data.weakness;
                })
        ...
        methods: {
            onSubmit() {
                ...
                axios.put(`/product-competitors/${this.$route.params.id}`, this.data)
                    .then(response => {
