                                    ...
                                    <div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
                                        <div class="wizard-wrapper">
                                            <div class="wizard-label">
                                                <h3 class="wizard-title">توضیحات اولیه</h3>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                data: {
                    ...
                    environmental_effect: {economical: '', social: '', political: '', environmental: ''},
        ...
        created() {
            this.Auth.check();
            import('../../../wizard2');
            axios.get('/api/description-market/create')
                .then(response => {
        ...
        methods: {
            onSubmit() {
                ...
                axios.post(`/description-market`, this.data)
                    ...
                    .catch(error => {
                        Swal.fire({
                            title: "خطایی در اطلاعات وارد شده وجود دارد",
                            icon: "warning",
                            buttonsStyling: false,
                            showConfirmButton: false,
                            timer: 3000,
