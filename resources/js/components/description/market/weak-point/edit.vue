...
<script>
    ...
    export default {
        ...
        created() {
            axios.get(`/api/weak-points/${this.$route.params.id}/edit`)
                .then(response => {
                    this.data.weak_points[0].description = response.data.description;
                    this.data.weak_points[0].weight = response.data.weight;
                    this.data.weak_points[0].score = response.data.score;
                })
        ...
        methods: {
            onSubmit() {
                ...
                axios.put(`/weak-points/${this.$route.params.id}`, this.data)
                    .then(response => {
