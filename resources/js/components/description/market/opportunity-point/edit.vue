                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a class="text-muted">نقاط فرصت</a>
                            </li>
                            <li class="breadcrumb-item text-muted">
...
<script>
    ...
    export default {
        ...
        created() {
            axios.get(`/api/opportunity-points/${this.$route.params.id}/edit`)
                .then(response => {
                    this.data.opportunity_points[0].description = response.data.description;
                    this.data.opportunity_points[0].weight = response.data.weight;
                    this.data.opportunity_points[0].score = response.data.score;
                })
        ...
        methods: {
            onSubmit() {
                ...
                axios.put(`/opportunity-points/${this.$route.params.id}`, this.data)
                    .then(response => {
