                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-header border-0 py-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label font-weight-bolder text-dark">هزینه های انجام شده جهت رسیدن به دانش فنی</span>
                        </h3>
                        ...
                        <div class="card-toolbar">
                            <router-link :to="{ name: 'valuation-costs-create' }">
                        ...
                        <div class="table-responsive">
                            <table class="table table-head-custom table-head-bg table-vertical-center table-borderless" id="myTable">
                                ...
                                <tr v-for="(cost, index) in costsFilter" :id="'del_'+cost.id" class="text-center">
                                    ...
                                    <td>
                                        <span class="text-dark-75">{{ cost.description }}</span>
                                    </td>
                                    <td>
                                        <span class="text-dark-75">{{ cost.total_price }}</span>
                                    </td>
                                    <td>
                                        <router-link :to="{ name: 'valuation-costs-edit', params: { id: cost.id }}">
...
<script>
    ...
    export default {
        ...
        computed: {
            costsFilter() {
                return this.costs.filter((element) => {
                    if(!this.filterText){
                        return element
                    }else{
