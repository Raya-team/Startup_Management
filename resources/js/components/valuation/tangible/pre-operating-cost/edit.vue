...
<script>
    ...
    export default {
        ...
        created() {
            axios.get(`/api/val-pre-operating-costs/${this.$route.params.id}/edit`)
                .then(response => {
                    console.log(response);
                    this.shareholders = response.data.shareholders;
                    this.pre_operation_costs = response.data.pre_operation_costs;
                    this.data.valuation_pre_operation_costs[0] = response.data.valuation_pre_operation_costs;
                })
        ...
        methods: {
            onSubmit() {
                ...
                axios.put(`/val-pre-operating-costs/${this.$route.params.id}`, this.data)
                    .then(response => {
