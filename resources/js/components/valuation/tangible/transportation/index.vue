                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-header border-0 py-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label font-weight-bolder text-dark">وسایل حمل و نقل</span>
                        </h3>
                        ...
                        <div class="card-toolbar">
                            <router-link :to="{ name: 'val-transportations-create' }">
                    ...
                    <div class="card-body pt-0 pb-3">
                        ...
                        <div class="table-responsive">
                            <table class="table table-head-custom table-head-bg table-vertical-center table-borderless" id="myTable">
                                ...
                                <tbody>
                                <tr v-for="(transportation, index) in ValuationTransportationsFilter" :id="'del_'+transportation.id" class="text-center">
                                    <td>
                                    ...
                                    <td>
                                        <router-link :to="{ name: 'val-transportations-edit', params: { id: transportation.id }}">
...
<script>
    ...
    export default {
        ...
        methods: {
            getResults(pagi) {
                pagi = pagi || `/api/val-transportations`;
                axios.get(pagi)
                    .then(response => {
            ...
            deleteTransportation(id, index) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        axios.delete(`/val-transportations/${id}`)
                            .then(response => {
        ...
        computed: {
            ValuationTransportationsFilter() {
