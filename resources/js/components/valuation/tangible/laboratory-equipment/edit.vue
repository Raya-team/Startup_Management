                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a class="text-muted">تجهییزات آزمایشگاهی</a>
                            </li>
                            <li class="breadcrumb-item text-muted">
...
<script>
    ...
    export default {
        ...
        created() {
            axios.get(`/api/val-laboratory-equipments/${this.$route.params.id}/edit`)
                .then(response => {
                    console.log(response);
                    this.shareholders = response.data.shareholders;
                    this.laboratory_equipments = response.data.laboratory_equipments;
                    this.data.valuation_laboratory_equipments[0] = response.data.valuation_laboratory_equipments;
                })
        ...
        methods: {
            onSubmit() {
                ...
                axios.put(`/val-laboratory-equipments/${this.$route.params.id}`, this.data)
                    .then(response => {
