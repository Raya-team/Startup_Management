                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a class="text-muted">تجهیزات و لوازم دفتری</a>
                            </li>
                            <li class="breadcrumb-item text-muted">
...
<script>
    ...
    export default {
        ...
        created() {
            axios.get(`/api/val-office-supplies/${this.$route.params.id}/edit`)
                .then(response => {
                    console.log(response);
                    this.shareholders = response.data.shareholders;
                    this.office_supplies = response.data.office_supplies;
                    this.data.valuation_office_supplies[0] = response.data.valuation_office_supplies;
                })
        ...
        methods: {
            onSubmit() {
                ...
                axios.put(`/val-office-supplies/${this.$route.params.id}`, this.data)
                    .then(response => {
