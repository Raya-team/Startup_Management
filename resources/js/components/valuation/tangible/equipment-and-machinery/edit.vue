...
<script>
    ...
    export default {
        ...
        created() {
            axios.get(`/api/val-equipment-and-machineries/${this.$route.params.id}/edit`)
                .then(response => {
                    console.log(response);
                    this.shareholders = response.data.shareholders;
                    this.machineries = response.data.machineries;
                    this.data.valuation_machineries[0] = response.data.valuation_machineries;
                })
        ...
        methods: {
            onSubmit() {
                ...
                axios.put(`/val-equipment-and-machineries/${this.$route.params.id}`, this.data)
                    .then(response => {
