        ...
        <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="card-toolbar">
                    <router-link :to="{ name: 'justificationplan-edit', params: { id: team.id } }">
                        ...
                        <div class="card-body pt-0 pb-3">
                            ...
                            <div class="table-responsive">
                                <table class="table table-head-custom table-head-bg table-vertical-center table-borderless" id="myTable3">
                                    ...
                                    <tr class="text-center">
                                        <td>
                                            <span class="text-dark-75">{{ business_question.growth_center }}</span>
                                        </td>
                                        <td>
                                            <span class="text-dark-75">{{ business_question.start_date }}</span>
                                        </td>
                                        <td>
                                            <span class="text-dark-75">{{ business_question.location_address }}</span>
                                        </td>
                                        <td>
                                            <span class="text-dark-750">{{ business_question.phone_number }}</span>
                                        </td>
                                        <td>
                                            <span class="text-dark-750">{{ business_question.site_address }}</span>
                                        </td>
                                        <td>
                                            <span class="text-dark-750">{{ business_question.important_note }}</span>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
        ...
        created() {
            ...
            axios.get('/api/justificationplan')
                .then(response => {
                    ...
                    this.justification_plan = response.data.justification_plan;
