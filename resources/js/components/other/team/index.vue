                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="font-weight-bolder font-size-lg text-dark-75 text-right align-middle" v-if="team.landline != null">{{ team.landline }}</td>
                                            <td class="font-weight-bolder font-size-lg text-dark-75 text-right align-middle" v-else> ثبت نشده</td>
                                        </tr>
                                        <!--end::Item-->  <!--begin::Item-->
                                        <tr>
                                            <td class="w-40px pl-0 pr-2">
                                            ...
                                            <td class="font-weight-bolder font-size-lg text-dark-75 text-right align-middle" v-if="team.address != null">{{ team.address }}</td>
                                            <td class="font-weight-bolder font-size-lg text-dark-75 text-right align-middle" v-else> ثبت نشده</td>
                                        </tr>
                                        <!--end::Item-->
                                        </tbody>
