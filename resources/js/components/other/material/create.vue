...
<script>
    ...
    export default {
        ...
        created() {
            this.Auth.check();
            axios.get('/api/materials/create')
                .then(response => {
        ...
        methods: {
            AddField() {
                this.counter ++;
                this.data.material.push({ name: '',product_name: '' });
                this.name_error.push(`material.${this.counter}.name`);
                this.type_error.push(`material.${this.counter}.product_name`);
            },
            RemoveField(index) {
            ...
            onSubmit() {
                ...
                axios.post('/materials', this.data)
                    .then(response => {
                        if(response.data[0] == 'success'){
                            Swal.fire({
                                title: "مواد اولیه با موفقیت ثبت شدند",
                                icon: "success",
