...
<div id="app">
                            ...
                            <div class="topbar-item">
                                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                                    ...
                                    <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
											<span class="symbol-label font-size-h5 font-weight-bold">{{ substr(strtoupper(Auth::user()->username), 0, 1) }}</span>
                                    </span>
                                </div>
                            </div>
                            <!--end::User-->
    ...
    <!--end::Main-->
    <!-- begin::User Panel-->
    <div id="kt_quick_user" class="offcanvas offcanvas-right p-10" style="height: 300px; border-radius: 20px">
        <!--begin::Header-->
        <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
            <h3 class="font-weight-bold m-0">پروفایل کاربری</h3>
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="text-muted mt-1">{{ Auth::user()->team->name }}</div>
                    <div class="navi mt-2">
                        <div class="navi-item">
