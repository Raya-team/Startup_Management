...
<head><base href="../../../">
    ...
    <!--end::Layout Themes-->
    <link rel="shortcut icon" href="{{ asset('assets/css/fonts.css') }}" />
...
<div class="d-flex flex-column flex-root">
    <!--begin::Error-->
    <div class="error error-6 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-color: #0d8ddc">
        <!--begin::Content-->
        <div class="d-flex flex-column flex-row-fluid text-center">
            <p class="display-4 font-weight-bold text-white" style="margin-top: auto; margin-bottom: auto">{{ $value }}</p>
        </div>
        <!--end::Content-->
    </div>
    <!--end::Error-->
