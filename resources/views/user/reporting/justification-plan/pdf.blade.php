...
<div class="container">
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h1 class="card-title" style="margin: auto;text-align: center; font-size: 20px;"><b>اطلاعات مدیریتی</b></h1>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h1 class="card-title" style="margin: auto;text-align: center; font-size: 20px;"><b>اطلاعات فنی</b></h1>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h1 class="card-title" style="margin: auto;text-align: center; font-size: 20px;"><b>اطلاعات بازار</b></h1>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h1 class="card-title" style="margin: auto;text-align: center; font-size: 20px;"><b>اطلاعات تولید</b></h1>
                </div>
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h1 class="card-title" style="margin: auto;text-align: center; font-size: 20px;"><b>اطلاعات مالی</b></h1>
                </div>
                <div class="card-body">
