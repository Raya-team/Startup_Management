                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless mb-0">
                                ...
                                <tr>
                                    ...
                                    <td class="font-size-lg font-weight-bolder text-dark-75 align-middle w-150px pb-6">نام طرح</td>
                                    <td class="font-weight-bolder font-size-lg  text-dark-75 text-right align-middle pb-6">{{$team->project_name}}</td>
                                </tr>
                                <!--end::Item-->
                                <!--begin::Item-->
                                <tr>
                                    ...
                                    @if($team->status == 1)
                                        <td class="font-weight-bolder font-size-lg text-dark-75 text-right align-middle pb-6">بله</td>
                                    @elseif($team->status == 0)
                                        <td class="font-weight-bolder font-size-lg text-dark-75 text-right align-middle pb-6">خیر</td>
                                    @endif
                                </tr>
                                <!--end::Item-->
                                <!--begin::Item-->
                                <tr>
                                    ...
                                    <td class="font-size-lg font-weight-bolder text-dark-75 w-150px align-middle pb-6">ایمیل</td>
                                    <td class="font-weight-bolder font-size-lg text-dark-75 text-right align-middle pb-6">{{$team->email}}</td>
                                </tr>
                                <!--end::Item-->
                                <!--begin::Item-->
                                <tr>
                                    ...
                                    <td class="font-size-lg font-weight-bolder text-dark-75 w-150px align-middle">شماره همراه</td>
                                    <td class="font-weight-bolder font-size-lg text-dark-75 text-right align-middle">{{$team->phone_number}}</td>
                                </tr>
                                <!--end::Item-->
                                <!--begin::Item-->
                                <tr>
                                    ...
                                    <td class="font-size-lg font-weight-bolder text-dark-75 w-150px align-middle">شماره ثابت شهری</td>
                                    @if($team->landline != null)
                                        <td class="font-weight-bolder font-size-lg text-dark-75 text-right align-middle">{{$team->landline}}</td>
                                    @else
                                        <td class="font-weight-bolder font-size-lg text-dark-75 text-right align-middle"> ثبت نشده</td>
                                    @endif
                                </tr>
                                <!--end::Item-->  <!--begin::Item-->
                                <tr>
                                    ...
                                    <td class="font-size-lg font-weight-bolder text-dark-75 w-150px align-middle">آدرس</td>
                                    @if($team->address != null)
                                        <td class="font-weight-bolder font-size-lg text-dark-75 text-right align-middle">{{$team->address}}</td>
                                    @else
                                        <td class="font-weight-bolder font-size-lg text-dark-75 text-right align-middle"> ثبت نشده</td>
                                    @endif
                                </tr>
