...
class TechnologyQuestionRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'q31' => ['required', 'boolean'],
            'q32' => ['required', 'boolean'],
            'q33' => ['required', 'boolean'],
            'q34' => ['required', 'boolean'],
            'q35' => ['required', 'boolean'],
        ];
    }
}
