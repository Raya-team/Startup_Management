...
use App\Http\Requests\CustomerRecognitionQuestionRequest;
...
class CustomerRecognitionController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(CustomerRecognitionQuestionRequest $request, $id)
    {
        $team_id = Auth::user()->team_id;

        $data = CustomerRecognitionQuestion::findorfail($id);
