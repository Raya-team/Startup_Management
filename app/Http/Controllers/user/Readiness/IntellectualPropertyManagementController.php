...
class IntellectualPropertyManagementController extends Controller
{
    /**
    ...
    public function edit($id)
    {
        ...
        $questions = IntellectualPropertyManagementQuestion::findorfail($id);
    ...
    public function update(IntellectualPropertyManagementQuestionRequest $request, $id)
    {
        ...
        $data = IntellectualPropertyManagementQuestion::findorfail($id);
