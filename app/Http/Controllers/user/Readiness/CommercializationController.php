...
use App\Http\Requests\CommercializationQuestionRequest;
...
class CommercializationController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $questions = CommercializationQuestion::findorfail($id);
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(CommercializationQuestionRequest $request, $id)
    {
        $team_id = Auth::user()->team_id;

        $data = CommercializationQuestion::findorfail($id);
