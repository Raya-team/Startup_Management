...
use App\Http\Requests\BusinessQuestionRequest;
...
class BusinessController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(BusinessQuestionRequest $request)
    {
     ...
     * @param $team_id
     */
    protected function Commercialization(BusinessQuestionRequest $request, $team_id)
    {
     ...
     * @param $team_id
     */
    protected function PublicManagement(BusinessQuestionRequest $request, $team_id)
    {
     ...
     * @param $team_id
     */
    protected function FunctionalManagement(BusinessQuestionRequest $request, $team_id)
    {
     ...
     * @param $team_id
     */
    protected function SaleAndTechnicalSupport(BusinessQuestionRequest $request, $team_id)
    {
     ...
     * @param $team_id
     */
    protected function LiquidityAndAccessToCapital(BusinessQuestionRequest $request, $team_id)
    {
     ...
     * @param $team_id
     */
    protected function CompetitivePosition(BusinessQuestionRequest $request, $team_id)
    {
     ...
     * @param $team_id
     */
    protected function CustomerRecognition(BusinessQuestionRequest $request, $team_id)
    {
     ...
     * @param $team_id
     */
    protected function CustomerCommitment(BusinessQuestionRequest $request, $team_id)
    {
     ...
     * @param $team_id
     */
    protected function Affordable(BusinessQuestionRequest $request, $team_id)
    {
     ...
     * @param $team_id
     */
    protected function IntellectualPropertyManagement(BusinessQuestionRequest $request, $team_id)
    {
     ...
     * @param $team_id
     */
    protected function SaleForecast(BusinessQuestionRequest $request, $team_id)
    {
     ...
     * @param $team_id
     */
    protected function UncertaintyPrediction(BusinessQuestionRequest $request, $team_id)
    {
     ...
     * @param $team_id
     */
    protected function SupplyChain(BusinessQuestionRequest $request, $team_id)
    {
     ...
     * @param $team_id
     */
    protected function Rule(BusinessQuestionRequest $request, $team_id)
    {
