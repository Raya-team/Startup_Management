...
trait FormulasTrait
{
    public function Formulas()
    {
        ...
        $loan = $fiscal->loan;
        /* خالص سرمایه گذاری */
        $net_investment = ($total_tenements + $total_equipment_and_machineries + $total_laboratory_equipments + $total_facilities + $total_transportations + $total_office_equipment_and_supplise + $total_pre_operating_cost) - $loan;
        ...
        array_push($zero_year, [
            'محل اجرای طرح', $total_tenements,
            'تجهیزات فنی', $total_equipment_and_machineries,
            'تجهیزات آزمایشگاهی', $total_laboratory_equipments,
            'تاسیسات', $total_facilities,
            'وسایل حمل و نقل', $total_transportations,
            'تجهیزات دفتری', $total_office_equipment_and_supplise,
            'هزینه قبل بهره‌برداری', $total_pre_operating_cost,
