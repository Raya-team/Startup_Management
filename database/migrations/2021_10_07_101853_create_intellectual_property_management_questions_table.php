...
class CreateIntellectualPropertyManagementQuestionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('intellectual_property_management_questions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('intellectual_property_management_questions');
    }
}
