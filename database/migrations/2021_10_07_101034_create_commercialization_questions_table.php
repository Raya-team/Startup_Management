...
class CreateCommercializationQuestionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('commercialization_questions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('commercialization_questions');
    }
}
