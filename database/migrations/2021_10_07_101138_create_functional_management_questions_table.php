...
class CreateFunctionalManagementQuestionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('functional_management_questions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('functional_management_questions');
    }
}
