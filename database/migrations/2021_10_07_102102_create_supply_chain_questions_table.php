...
class CreateSupplyChainQuestionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('supply_chain_questions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('supply_chain_questions');
    }
}
