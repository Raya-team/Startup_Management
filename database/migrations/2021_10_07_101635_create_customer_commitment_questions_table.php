...
class CreateCustomerCommitmentQuestionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('customer_commitment_questions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('customer_commitment_questions');
    }
}
