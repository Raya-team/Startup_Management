...
class CreateLiquidityAndAccessToCapitalQuestionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('liquidity_and_access_to_capital_questions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('liquidity_and_access_to_capital_questions');
    }
}
