...
class CreateSaleAndTechnicalSupportQuestionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sale_and_technical_support_questions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sale_and_technical_support_questions');
    }
}
