...
class CreateSaleForecastQuestionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sale_forecast_questions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sale_forecast_questions');
    }
}
