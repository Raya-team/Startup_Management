...
class CreateAffordableQuestionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('affordable_questions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('affordable_questions');
    }
}
