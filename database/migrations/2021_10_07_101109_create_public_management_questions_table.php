...
class CreatePublicManagementQuestionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('public_management_questions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('public_management_questions');
    }
}
