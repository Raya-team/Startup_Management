...
class CreateCompetitivePositionQuestionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('competitive_position_questions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('competitive_position_questions');
    }
}
