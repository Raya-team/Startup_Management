...
class CreateTechnologyQuestionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('technology_questions', function (Blueprint $table) {
            $table->id();
            ...
            $table->boolean('q31')->default(false);
            $table->boolean('q32')->default(false);
            $table->boolean('q33')->default(false);
            $table->boolean('q34')->default(false);
            $table->boolean('q35')->default(false);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('technology_questions');
    }
}
