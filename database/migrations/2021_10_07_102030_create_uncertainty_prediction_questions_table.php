...
class CreateUncertaintyPredictionQuestionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('uncertainty_prediction_questions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('uncertainty_prediction_questions');
    }
}
